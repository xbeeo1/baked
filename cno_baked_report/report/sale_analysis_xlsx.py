...
class SaleAnalysisXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, report):
        ...
        sheet.write(row, 13, 'Discounts', format3_colored)
        sheet.write(row, 14, 'Net sales', format3_colored)
        sheet.write(row, 15, 'Unit Cost/Vendor Cost', format3_colored)
        ...
        for order in pos_orders:
            ...
            for line in order.lines:
                ...
                sheet.write(row, 13, dic, center_right)
                sheet.write(row, 14, net_sale, center_right)
